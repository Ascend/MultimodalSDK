...
3. **镜像拉取示例**
   ...
   docker tag swr.cn-south-1.myhuaweicloud.com/ascendhub/multimodalsdk:26.1.0-910b-ubuntu22.04-py3.11-aarch64 \
       multimodalsdk:26.1.0-910b-ubuntu22.04-py3.11-aarch64
   ```
