...
class ThreadPool
{
   public:
    ...
    /**
     * @brief Copy constructor is disabled (singleton ownership of worker threads)
     */
    ThreadPool(const ThreadPool&) = delete;
    /**
     * @brief Copy assignment is disabled (singleton ownership of worker threads)
     */
    ThreadPool& operator=(const ThreadPool&) = delete;
    /**
     * @brief Move constructor is disabled (singleton ownership of worker threads)
     */
    ThreadPool(ThreadPool&&) = delete;
    /**
     * @brief Move assignment is disabled (singleton ownership of worker threads)
     */
