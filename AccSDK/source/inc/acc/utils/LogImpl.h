...
class LogMessage
{
   public:
    ...
    // -------------------------------------------------------------------------
    // LogMessage is designed as a RAII object that should not be copied or moved.
    // Copying would result in duplicate log entries; moving would complicate
    // the destructor's output timing.
