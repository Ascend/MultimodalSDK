...
class XPUAccelerator
{
   public:
    ...
    /**
     * @brief Default constructor: creates an empty XPUAccelerator instance
     */
    XPUAccelerator() = default;
    /**
     * @brief Copy constructor: performs member-wise copy
     */
    XPUAccelerator(const XPUAccelerator&) = default;
    /**
     * @brief Copy assignment operator: assigns from another XPUAccelerator
     */
    XPUAccelerator& operator=(const XPUAccelerator&) = default;
    /**
     * @brief Move constructor: enables efficient transfer of resources
     */
    XPUAccelerator(XPUAccelerator&&) = default;
    /**
     * @brief Move assignment operator: enables efficient transfer from another accelerator
     */
    XPUAccelerator& operator=(XPUAccelerator&&) = default;
